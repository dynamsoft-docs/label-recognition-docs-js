...
<!--The original doc is hosted here => https://github.com/dynamsoft-docs/label-recognition-docs/blob/master/programming/javascript/user-guide/index.md -->
...
3. Learn about the available [APIs]({{ site.dlr_js_api }}).
