...
permalink: /programming/javascript/user-guide/index-v2.2.11.html
---
...
The following table is a list of supported browsers based on the above requirements:
  ...
  > Note: iOS 12 is currently not compatible with Dynamsoft Label Recognizer v 2.2.11+, due to certain technical limitations.
